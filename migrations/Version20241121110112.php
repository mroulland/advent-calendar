 ...
 */
final class Version20241121110112 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE calendar (id INT AUTO_INCREMENT NOT NULL, challenge_id INT DEFAULT NULL, date DATE NOT NULL, INDEX IDX_6EA9A14698A21AC6 (challenge_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE challenge (id INT AUTO_INCREMENT NOT NULL, description LONGTEXT NOT NULL, type VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE quiz_challenge (id INT NOT NULL, questions JSON NOT NULL COMMENT \'(DC2Type:json)\', answers JSON NOT NULL COMMENT \'(DC2Type:json)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ranking (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, points INT NOT NULL, INDEX IDX_80B839D0A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ranking_challenge (ranking_id INT NOT NULL, challenge_id INT NOT NULL, INDEX IDX_CA13F66C20F64684 (ranking_id), INDEX IDX_CA13F66C98A21AC6 (challenge_id), PRIMARY KEY(ranking_id, challenge_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
